...
%SEE NELSON, ROLE OF PEDIATRICIAN P. 223 (pdf p.334) %TODO
...
\cite{nelson} states that results of specific diagnostic studies and laboratory tests performed in the country of origin should not be relied on and should be repeated once the child arrives in the country of destination. Paradoxically, review of the child’s medical records may raise more questions than provide answers, because of poor translation and use of medical terminology and medications that are unfamiliar to trained physicians. Each medical diagnosis should be considered carefully before being rejected or accepted.
