...
Specialists should adives prospective parents on appropriate testing of the child after arrival in the country of destination. Early screening is crucial in order to identify eventual pathological conditions and to prevent what could be irreversible damage. As can be found in \cite{initialeval} and \cite{redbook}, the American Academy of Pediatrics recommends careful health screening of all newly arrived international adoptees.
Several reports focused on infectious disease risk among internationally adopted children, while data regarding prevalence and spectrum of non-infectious conditions, including special needs, are poor (see \cite{notonlyinfectious} and \cite{nonsoloinfezioni}).
