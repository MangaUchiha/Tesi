...
Several systematic reviews and eminent periodicals focused on infectious disease risk among internationally adopted children, while data regarding prevalence and spectrum of non-infectious conditions, including special needs, are poor (see \cite{notonlyinfectious} and \cite{nonsoloinfezioni}). Many studies (a.e. see \cite{notonlyinfectious}) have assessed prevalence of all infections, ranging between 35 and 42\% for all infections, ~40\% for parasitic ones, and between 5 and 19\% for tuberculosis. 
