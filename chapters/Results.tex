...
As stated in Section \ref{sec:thepopulationinexam}, 285 internationally adopted children were evaluated from January \nth{1}, 2002 to December \nth{31}, 2017; 102 were female (36.17\%) and 180 male (63.83\%). The three missing children are due to sex never being registered in the dataset. Boys were numerically dominant in all considered regions (55-79\%).\\
...
As for the immunization status, only 87 (34.25\%) showed a completely valid immunization to vaccine-preventable disease. Almost 65\% of all children were found to have insufficient antibody levels for at least one of the considered infections. Three children were exposed \textit{entirely}. The following Table \ref{tab:immunizationperregion} shows the immunization status, regarded as \textit{complete}, \textit{incomplete} or \textit{absent} for every considered geographical region. Africa resulted being the region with the lowest immunization rate (just over $\sim 10\%$).
...
Out of 285 examined children, on 180 vitamin D serum levels were tested: 60 (33.33\%) were defined deficient, 12 (6.67\%) insufficient, and no children were found to be severely insufficient. Only 108 (60\%) had sufficient (and therefore acceptable) vitamin D intake. Most of the children who suffered insufficiency were Asian ($8/12\simeq66.66\%$).\\
The \textit{Kruskal-Wallis equality-of-populations rank test} was performed in order to verify if there were any statistically significant differences in vitamin D mean serum levels between our four zones. Its results were on the limits of statistical significance ($p$-$value=0.0524$). Table \ref{tab:vitamindperregion} shows the number of considered cases ($n$), mean serum levels of vitamin D ($m$) and standard deviation ($\sigma$) in each considered region.
...
The \textit{two-sample Mann-Whitney-Wilcoxon rank-sum test} was performed on each region between Mantoux test results and mean age in the positive and negative groups. It returned a statistically significant ($p$\textgreater$|z|=0.028$) result only for Asia: positive Asiatic children had a mean age of 85 month ($\sigma=31.61$), negative 62 months ($\sigma=37.56$). We believe that with bigger sample sizes, this would be found true for Latin America as well.\\
...
Then, we further studied anemias, by running a \textit{logistic regression}. Anemia was considered as a dichotomous variable (a child either was anemic, or he wasn't), and so was done for parasitic infections, MCV, and ferritin serum levels. We found that anemia is negatively correlated with MCV levels ($z=-3.18$, $p>|z|=0.001$ with a $CI_{95\%} =[0.75,0.93]$). This consideration visibly stands out in Table \ref{tab:HbMCV}. Out of 22 anemias, 9 alongside a pathological MCV ($\sim 41\%$); on the other hand, only 11\% of non-anemic children presented a pathological MCV value.\\
...
\begin{table}[H]
   ...
   \begin{tabular}{c l c c | r}
      ...
      \hline
       \parbox[t]{2mm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{MCV}}} & Normal & 228 (82.31\%) & 27 (9.75\%) & 255 (92.06\%)\\
...
Because of this strong correlation between low-MCV and low-haemoglobin, we decided to consider as one the population with these two parameters offset (3.25\% of all studied cases) and try to find out more about the etiological nature of this anemic state. We found that there was a positive correlation between low ferritin serum levels and low-MCV anemia, confirming the high prevalence of iron-deficiency in our population. This was established at the \textit{Fisher's exact test} ($p=0.001$). Table \ref{tab:Ferritin_HbMCV} shows our data concerning these considerations.\\
...
%Begin Table on Ferritin and Hb+MCV
\begin{table}[H]
   \centering
   \begin{tabular}{c l c c | r}
       ...
       & & Absent & Present & Total\\
      \hline
       \parbox[t]{2mm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\footnotesize{Ferritin}}}} & Normal & 162 (65.32\%) & 1 (0.40\%) & 163 (65.73\%)\\
...
%Begin Tables on Parasites and Hb
\begin{table}[!ht]
\centering
	...
	\renewcommand{\arraystretch}{1.3}
		\begin{tabular}{c l c c c | r}
		       ...
		       & & Absent & Mild & Moderate & Total\\
		      \hline
		       \parbox[t]{0.6cm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\begin{scriptsize}\begin{tabular}[t]{@{}c@{}}Parasitic\\infection\end{tabular}\end{scriptsize}}}} & Absent & 130 (53.50\%) & 7 (2.88\%) & 5 (2.06\%) & 142 (58.44\%)\\
	...
	\begin{subtable}{.8\textwidth}
		...
		\begin{tabular}{c l c c | r}
			  ...
			  \cline{3-4}
		       & & Absent & Present & Total\\
		      \hline
		       \parbox[t]{0.6cm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\begin{scriptsize}\begin{tabular}[t]{@{}c@{}}Parasitic\\infection\end{tabular}\end{scriptsize}}}} & Absent & 176 (72.13\%) & 8 (3.28\%) & 184 (75.41\%) \\
	...
	\begin{subtable}{.8\textwidth}
		...
		\begin{tabular}{c l c c | r}
			  ...
			  \cline{3-4}
		       & & Absent & Present & Total\\
		      \hline
		       \parbox[t]{0.6cm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\begin{scriptsize}\begin{tabular}[t]{@{}c@{}}Parasitic\\infection\end{tabular}\end{scriptsize}}}} & Absent & 188 (77.05\%) & 6 (2.46\%) & 194 (79.51\%) \\
