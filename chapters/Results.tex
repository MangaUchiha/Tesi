...
\centering
	\begin{tikzpicture}
		...
		xticklabels={%
		    {{\scriptsize Negative Positive}\\Africa},%
		    {{\scriptsize Negative Positive}\\Asia},%
		    {{\scriptsize Negative Positive}\\Eastern Europe},%
		    {{\scriptsize Negative Positive}\\Latin America},%
		},
		    x tick label style={
		        text width=2.8cm,
		        align=center
