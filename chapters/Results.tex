...
\footnotetext[3]{Regions were ordered by the ascending mean levels of serum vitamin D.}
...
\begin{table}[H]
   ...
   \begin{tabular}{l r r | r}
   	  ...
   	  \cline{2-3}
      Region\footnotemark[4] & Positive & Negative & Total\\
      \hline
...
\footnotetext[4]{Regions were ordered by the descending percentage of positive tests.}
